...
do
	...
	function ColorSelect:Create(name, parent, hasOpacity, SaveColor, LoadColor)
		...
		local edgebg = f:CreateTexture(nil, 'BACKGROUND')
		edgebg:SetWidth(21); edgebg:SetHeight(21)
		edgebg:SetTexture(1, 1, 1)
		edgebg:SetPoint('CENTER')
		self.edgebg = edgebg
...
do
	...
	function Menu:AddDisplayPanel()
		...
		--border color picker
		local edgeColor = layout:CreateColorSelector(L.EdgeColor, true)
		edgeColor.SaveColor = function(c, ...)
			self.parent:SetEdgeColor(...)
		end
		edgeColor.LoadColor = function(c)
			return self.parent:GetEdgeColor()
		end
		edgeColor:SetPoint('TOPLEFT', showBorders, 'BOTTOMLEFT', 105, 0)
		layout.height = layout.height + 30
