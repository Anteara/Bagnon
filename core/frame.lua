...
function BagnonFrame:LoadSettings(sets)
	...
	local rB,gB,bB,aB = self:GetEdgeColor()
	self:SetBackdropColor(r, g, b, a)
	self:SetBackdropBorderColor(rB, rB, rB, a)
...
function BagnonFrame:GetEdgeColor()
	local edgebg = self.sets.edgebg
	DEFAULT_CHAT_FRAME:AddMessage(edgebg.rB);
	return edgebg.rB, edgebg.gB, edgebg.bB, edgebg.aB
end

function BagnonFrame:SetEdgeColor(r, g, b, a)
	local edgebg = self.sets.edgebg
	edgebg.rB = r; edgebg.gB = g; edgebg.bB = b; edgebg.aB = a
